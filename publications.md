...
<ol reversed>
  <li>Patel, Jinaykumar, and Subbaraom, Kamesh. "<span style="color:blue">Rendezvous and Proximity Operations using Model Predictive Control based on Set Membership Filter.</span>" 2023 American Control Conference (ACC). (2023). Accepted</li>
